...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__node_modules_webcomponents_webcomponentsjs_webcomponents_loader_js__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__view__ = __webpack_require__(16);
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "MyApp", function() { return __WEBPACK_IMPORTED_MODULE_1__view__["a"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_mixins_element_mixin_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_utils_html_tag_js__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__template_stamp_js__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__layout__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_polymer_polymer_lib_elements_dom_repeat_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__node_modules_polymer_polymer_polymer_element_js__ = __webpack_require__(9);
...
class MyApp extends __WEBPACK_IMPORTED_MODULE_5__node_modules_polymer_polymer_polymer_element_js__["a" /* Element */] {
    ...
    constructor(words) {
        super();
        this._c = new __WEBPACK_IMPORTED_MODULE_0__game__["a" /* Controller */](words);
        this._newGame();
        this._newRound();
        this.wrong = false;
    ...
    _newRound() {
        ...
        this.answers = resp.answers.map(a => ({
            word: a,
            hidden: true,
            spaces: __WEBPACK_IMPORTED_MODULE_1_lodash__["times"](a.length, () => '_ ').join('')
        }));
    ...
    styleOf(wordIdx, letterIdx) {
        let lh = new __WEBPACK_IMPORTED_MODULE_3__layout__["a" /* LayoutHelper */](this._layout);
    ...
    ready() {
        ...
        this._layout = __WEBPACK_IMPORTED_MODULE_3__layout__["b" /* getOptimalLayout */](answers, 0.2, 1.2, this.$.answers.offsetWidth, this.$.answers.offsetHeight);
    ...
    _updateTime() {
        ...
        this.time = __WEBPACK_IMPORTED_MODULE_2__util__["a" /* formatMillis */](timeLeft);
    }
    _heartbeat() {
        this._updateTime();
...
class Controller {
    ...
    newRound() {
        ...
        let gameStructure = __WEBPACK_IMPORTED_MODULE_0_lodash__["sample"](this._wordList.containment);
        let tiles = __WEBPACK_IMPORTED_MODULE_0_lodash__["shuffle"](this._wordList.words[gameStructure.fullWord].split(''));
        let answers = gameStructure.subwords.map(i => this._wordList.words[i]);
        answers = __WEBPACK_IMPORTED_MODULE_0_lodash__["sortBy"](answers, ['length', __WEBPACK_IMPORTED_MODULE_0_lodash__["identity"]]);
    ...
    heartbeat() {
        ...
        if (this._endTime < Date.now()) {
            this._state = GameState.STATE_WAITING_FOR_NEXT_ROUND;
            let toReveal = __WEBPACK_IMPORTED_MODULE_0_lodash__["filter"]([...this._answers.keys()], (idx) => !this._answers[idx].guessed);
            return {
                roundEnd: {
                    reveal: toReveal,
                },
    ...
    _nthEmpty(n) {
        let res = -1;
        for (let i = 0; i < n + 1; i++) {
            res = __WEBPACK_IMPORTED_MODULE_0_lodash__["findIndex"](this._available, (s) => s == -1, res + 1);
        }
        return res;
    }
    submit() {
        ...
        let answerIdx = __WEBPACK_IMPORTED_MODULE_0_lodash__["findIndex"](this._answers, {
            // @ts-ignore
            'answer': guess
        });
        if (answerIdx != -1) {
            if (this._answers[answerIdx].guessed) {
                return {
                    ...
                    score: this._score,
                    moves: __WEBPACK_IMPORTED_MODULE_0_lodash__["times"](guess.length, this._doBackspace.bind(this)),
                };
            }
            else {
    ...
    shuffle() {
        this._checkState(GameState.STATE_ROUND);
        let moves = [];
        let perm = __WEBPACK_IMPORTED_MODULE_0_lodash__["shuffle"](__WEBPACK_IMPORTED_MODULE_0_lodash__["range"](6));
        let newAvailable = [];
    ...
    typeCharacter(char) {
        ...
        let index = __WEBPACK_IMPORTED_MODULE_0_lodash__["findIndex"](this._tiles, t => t.letter == char && !t.isSuggestion);
        if (index == -1) {
            return {
                moves: []
            };
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = formatMillis;
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = getOptimalLayout;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);
...
function getLayout(answers, numCols, rowGutterFraction, columnGutterFraction, containerWidthPx, containerHeightPx) {
    ...
    let columns = __WEBPACK_IMPORTED_MODULE_0_lodash__["chunk"](answers, numRows);
    let columnWidths = columns.map(c => __WEBPACK_IMPORTED_MODULE_0_lodash__["last"](c).length);
    let width = __WEBPACK_IMPORTED_MODULE_0_lodash__["sum"](columnWidths) + columns.length * columnGutterFraction;
...
function getOptimalLayout(answers, rowGutterFraction, columnGutterFraction, containerWidthPx, containerHeightPx) {
    let layouts = __WEBPACK_IMPORTED_MODULE_0_lodash__["range"](1, 1 + answers.length).map((numCols) => getLayout(answers, numCols, rowGutterFraction, columnGutterFraction, containerWidthPx, containerHeightPx));
    return __WEBPACK_IMPORTED_MODULE_0_lodash__["maxBy"](layouts, t => t.tileSizePx);
}
class LayoutHelper {
    ...
    getWordCoordinates(wordIdx) {
        ...
        let widthOfPrevCols = __WEBPACK_IMPORTED_MODULE_0_lodash__["sum"](this._l.columnWidths.slice(0, columnIdx));
        return {
...
/* harmony export (immutable) */ __webpack_exports__["a"] = LayoutHelper;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_templatize_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_debounce_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_flush_js__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__property_effects_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__properties_mixin_js__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__properties_changed_js__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__boot_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__boot_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__boot_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_property_effects_js__ = __webpack_require__(11);
